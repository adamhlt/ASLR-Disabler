...
void UI::Render()
{
    ...
    ::RegisterClassEx(&wc);
    const HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("ASLR Disabler"), WS_OVERLAPPEDWINDOW, (GetSystemMetrics(SM_CXSCREEN) / 2) - 250, (GetSystemMetrics(SM_CYSCREEN) / 4), 50, 50, NULL, NULL, wc.hInstance, NULL);
